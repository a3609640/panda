...
setwd("~/Documents/Bioinformatics analysis/ChIP analysis/HepG2-SREBP1/MACS")

files <- list(HepG2.SREBP1 = "~/Documents/Bioinformatics analysis/ChIP analysis/HepG2-SREBP1/MACS/HepG2-merged-SREBP1-Input_peaks.narrowPeak",
              HepG2.HCF = "~/Documents/Bioinformatics analysis/ChIP analysis/HepG2-SREBP1/MACS/HepG2-merged-HCF-Input_peaks.narrowPeak",
              HepG2.YY1 = "~/Documents/Bioinformatics analysis/ChIP analysis/HepG2-SREBP1/MACS/HepG2-merged-YY1-Input_peaks.narrowPeak")
print(files)
# use readPeakFile function to load the peak and store in GRanges object
peak1 <- readPeakFile(files[["HepG2.SREBP1"]])
