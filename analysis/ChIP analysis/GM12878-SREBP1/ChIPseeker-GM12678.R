...
setwd("~/Documents/Bioinformatics analysis/ChIP analysis/GM12878-SREBP1/MACS")

files <- list(GM12878.SREBP1 = "~/Documents/Bioinformatics analysis/ChIP analysis/GM12878-SREBP1/MACS/GM12878-merged-SREBP1-Input_peaks.narrowPeak",
              GM12878.SREBP2 = "~/Documents/Bioinformatics analysis/ChIP analysis/GM12878-SREBP1/MACS/GM12878-merged-SREBP2-Input_peaks.narrowPeak",
              GM12878.HCF = "~/Documents/Bioinformatics analysis/ChIP analysis/GM12878-SREBP1/MACS/GM12878-merged-HCF-Input_peaks.narrowPeak",
              GM12878.YY1 = "~/Documents/Bioinformatics analysis/ChIP analysis/GM12878-SREBP1/MACS/GM12878-merged-YY1-Input_peaks.narrowPeak")

print(files)
# use readPeakFile function to load the peak and store in GRanges object
peak1 <- readPeakFile(files[["GM12878.SREBP1"]])
# peak1 <- "GM12878-SREBP1-1-Input-2_peaks.narrowPeak" # SREBP1-1 peak file name
peak1
# create tagmatrix
