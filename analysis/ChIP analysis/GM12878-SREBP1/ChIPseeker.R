...
setwd("~/Documents/Bioinformatics analysis/ChIP analysis/K562-SREBP1/MACS")
files <- list(SREBP1.rep1 = "/home/su/Documents/Bioinformatics analysis/ChIP analysis/K562-SREBP1/MACS/K562-SREBP1-1-Input-1_peaks.narrowPeak",
            #  SREBP1.rep2 = "/home/su/Documents/Bioinformatics analysis/ChIP analysis/K562-SREBP1/MACS/K562-SREBP1-2-Input-1_peaks.narrowPeak",
              SREBP1.rep3 = "/home/su/Documents/Bioinformatics analysis/ChIP analysis/K562-SREBP1/MACS/K562-SREBP1-1-Input-2_peaks.narrowPeak")
            # SREBP1.rep4 = "/home/su/Documents/Bioinformatics analysis/ChIP analysis/K562-SREBP1/MACS/K562-SREBP1-2-Input-2_peaks.narrowPeak")

files <- list(A549.SREBP1.rep1 = "/home/su/Documents/Bioinformatics analysis/ChIP analysis/A549-SREBP1/MACS/A549-SREBP1-1-Input-1_peaks.narrowPeak",
              A549.SREBP1.rep2 = "/home/su/Documents/Bioinformatics analysis/ChIP analysis/A549-SREBP1/MACS/A549-SREBP1-2-Input-1_peaks.narrowPeak",
              K562.SREBP1.rep1 = "/home/su/Documents/Bioinformatics analysis/ChIP analysis/K562-SREBP1/MACS/K562-SREBP1-1-Input-1_peaks.narrowPeak",
              K562.SREBP1.rep2 = "/home/su/Documents/Bioinformatics analysis/ChIP analysis/K562-SREBP1/MACS/K562-SREBP1-2-Input-1_peaks.narrowPeak",
              K562.HCF.rep1 = "/home/su/Documents/Bioinformatics analysis/ChIP analysis/K562-SREBP1/MACS/K562-HCF-1-Input-1_peaks.narrowPeak",
              K562.HCF.rep2 = "/home/su/Documents/Bioinformatics analysis/ChIP analysis/K562-SREBP1/MACS/K562-HCF-2-Input-1_peaks.narrowPeak",
              K562.YY1.rep1 = "/home/su/Documents/Bioinformatics analysis/ChIP analysis/K562-SREBP1/MACS/K562-YY1-1-Input-1_peaks.narrowPeak",
              K562.YY1.rep2 = "/home/su/Documents/Bioinformatics analysis/ChIP analysis/K562-SREBP1/MACS/K562-YY1-2-Input-1_peaks.narrowPeak")
print(files)
# use readPeakFile function to load the peak and store in GRanges object
peak1 <- readPeakFile(files[["A549.SREBP1.rep1"]])
...
gene <- seq2gene(peak1, tssRegion = c(-1000, 1000), flankDistance = 3000, TxDb=tx38)
pathway2 <- enrichPathway(gene, pvalueCutoff=0.05)
head(pathway2, 2)
dotplot(pathway2)
barplot(pathway2, showCategory=8)
############################################################################
